                    ...
                    <div class="col-md-3 col-sm-4 col-6 mb-3">
                        <div class="card">
                            ...
                            <div class="card-footer text-center">
                                <div class="card-btns">
                                    <form action="/store_wishlist/{{ $row->id }}" method="POST" class="d-inline">
                                    @csrf
                                        <button class="btn btn-danger btn-sm" title="Add to Wishlist"><i class="fa fa-heart-o"></i></button>
                                    </form>
                                    <form action="/store_cart/{{ $row->id }}" method="POST" class="d-inline">
                                        @csrf
                                        <button class="btn btn-primary btn-s" title="Add to Cart"><i class="fa fa-cart-plus" style="font-size: 1rem;"></i></button>
                                    </form>
                                </div>
                            </div>
                        </div>
